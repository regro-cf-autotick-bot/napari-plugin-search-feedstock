...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/napari-plugin-search-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15270&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/napari-plugin-search-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `napari-plugin-search` can be installed with:

```
conda install napari-plugin-search
```

It is possible to list all of the versions of `napari-plugin-search` available on your platform with:
